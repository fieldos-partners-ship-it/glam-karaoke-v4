...
export default function MobileStickyBar() {
  return (
    ...
    <div
      className="fixed bottom-0 left-0 right-0 z-50 h-14 md:hidden bg-neon-teal"
      role="complementary"
    ...
    >
      ...
      <a
        ...
        className="flex items-center justify-center w-full h-full gap-2 font-inter font-semibold text-stage-noir text-sm"
