    ...
    <section className="bg-stage-noir px-4 pb-24 pt-12 sm:px-6 lg:px-8" aria-label="Hours and location">
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="rounded-[30px] border border-white/10 bg-[linear-gradient(155deg,rgba(255,255,255,0.06),rgba(18,22,30,0.95))] p-8 shadow-[0_28px_90px_rgba(0,0,0,0.32)] md:p-10">
          ...
          <div className="rounded-[30px] border border-white/10 bg-[linear-gradient(180deg,rgba(24,18,24,0.95),rgba(11,14,19,0.98))] p-8 shadow-[0_28px_90px_rgba(0,0,0,0.32)] md:p-10">
            <div className="mb-6 flex items-center gap-3">
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-neon-teal/30 bg-neon-teal/10">
