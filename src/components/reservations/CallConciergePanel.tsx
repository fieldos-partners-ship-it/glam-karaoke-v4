...
const callWindow = Object.entries(businessInfo.hoursDisplay)
  ...
  return (
    <section className="bg-stage-noir px-4 py-10 sm:px-6 lg:px-8" aria-label="Call concierge">
      <div className="mx-auto max-w-7xl">
        <div className="relative overflow-hidden rounded-[32px] border border-white/10 bg-[linear-gradient(145deg,rgba(22,18,31,0.94),rgba(11,14,19,0.98))] p-8 shadow-[0_28px_90px_rgba(0,0,0,0.42)] md:p-10">
          ...
          <div className="relative grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
            <div>
              ...
              <div className="mb-6 rounded-[24px] border border-white/10 bg-white/5 p-5">
                <p className="font-inter text-xs uppercase tracking-[0.28em] text-soft-white/50">Best Time To Call</p>
                ...
                <p className="mt-2 font-inter text-sm leading-relaxed text-cool-mist">
                  We&apos;re open {callWindow}. Weekend prime-time slots move fastest, so calling earlier in the day helps.
                </p>
              </div>
